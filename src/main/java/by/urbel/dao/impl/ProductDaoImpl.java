package by.urbel.dao.impl;

import by.urbel.dao.ProductDao;
import by.urbel.dao.connection.ConnectionProvider;
...
public class ProductDaoImpl implements ProductDao {
    ...
    private static final String CREATE_PRODUCT_QUERY =
            "INSERT INTO products(name, category_id, description, price, quantity) VALUES (?,?,?,?,?)";
    private static final String SELECT_FIELDS =
            "SELECT p.id AS product_id, p.name AS product_name, p.description, p.price, p.quantity AS product_quantity," +
                    " pc.id AS category_id, pc.name AS category_name FROM products AS p " +
    ...
    private static final String UPDATE_PRODUCT_QUERY =
            "UPDATE products SET name=?, category_id=?, description=?, price=?, quantity=? " +
                    "WHERE id=?";
